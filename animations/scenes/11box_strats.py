...
# Ones left OPEN so the top section is INCOMPLETE → neutral blue bar (a complete
# top under 63 renders RED "missed-bonus", which is as distracting as the bonus).
CARD_C  = [None, 8,  6, 12, 10, 18, 20, 24, 25, None, 40, None, 22, None]      # 54 top, blue; open 1s/sm/yahtzee
CARD_EA = [None, 8,  6, 12, 10, 18, 20, 24, 25, None, None, 50, 22, None]      # 54 top, blue; open 1s/sm/lg
CARD_EB = [None, 8,  6, 12, 10, 18, 20, 24, 25, 30, None, 50, None, None]      # 54 top, blue; open 1s/lg/chance
